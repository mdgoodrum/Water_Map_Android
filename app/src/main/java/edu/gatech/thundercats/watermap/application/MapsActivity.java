    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        source.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(MapsActivity.this, CreateSource.class));
            }
        });
        purity = (Button) findViewById(R.id.purityButton);
        purity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MapsActivity.this, CreatePurity.class));
            }
        });
        viewPurity = (Button) findViewById(R.id.viewPurity);
        viewPurity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MapsActivity.this, ViewPurity.class));
            }
        });
        ...
        viewSource.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MapsActivity.this, ViewSource.class));
            }
        });
    }
